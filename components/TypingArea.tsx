...
export default function TypingArea({ phrase, typed }: TypingAreaProps) {
  return (
    <div className="w-full overflow-hidden rounded-lg border border-rule bg-white px-4 py-6 sm:px-10 sm:py-9">
      <p className="break-words font-mono text-[1.05rem] leading-relaxed tracking-wide sm:text-[1.3rem] lg:text-[1.55rem]">
